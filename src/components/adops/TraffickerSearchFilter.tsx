...
interface TraffickerSearchFilterProps {
  searchTerm: string;
...
const TraffickerSearchFilter: React.FC<TraffickerSearchFilterProps> = ({
  searchTerm,
  onSearchChange,
  ...
  // List of possible statuses - SOLO INCLUIMOS LOS ESTADOS PERMITIDOS PARA TRAFFICKERS
...
export default TraffickerSearchFilter;
