...
const OrganizationSubOrgs: React.FC<OrganizationSubOrgsProps> = ({
  ...
  const mockSubOrganizations: SubOrganization[] = [
    ...
    },
    {
      ...
      holdingId: "org004",
      isBigSix: true,
      legalName: "PHD Mexico S.A. de C.V.",
      taxId: "PHD123456MX",
      website: "https://www.phdmedia.com/mexico",
      contactName: "Carlos Rodriguez",
      contactEmail: "carlos.rodriguez@phd.com",
      status: "Active",
    },
    {
      id: "sub003",
      name: "Hearts & Science Mexico",
      type: "Agency",
      country: "Mexico",
      isHolding: false,
      holdingName: "Omnicom Media Group",
      holdingId: "org004",
      isBigSix: true,
      legalName: "Hearts & Science Mexico S.A. de C.V.",
      taxId: "HSC789012MX",
      website: "https://www.hearts-science.com/mexico",
      contactName: "Ana Martinez",
      contactEmail: "ana.martinez@hearts-science.com",
      status: "Active",
    },
    {
      id: "sub004",
      ...
      country: "Mexico",
      isHolding: false,
      holdingName: "Coca-Cola Latin America",
      holdingId: "org008",
      isBigSix: false,
      legalName: "Coca-Cola de México S.A. de C.V.",
      taxId: "CCM345678MX",
      website: "https://www.coca-cola.com.mx",
      contactName: "Roberto Sanchez",
      contactEmail: "roberto.sanchez@coca-cola.com",
      status: "Active",
    },
    {
      id: "sub005",
      ...
      holdingId: "org008",
      isBigSix: false,
      legalName: "Coca-Cola Brasil Ltda.",
      taxId: "CCB901234BR",
      website: "https://www.coca-cola.com.br",
      contactName: "Luiza Silva",
      contactEmail: "luiza.silva@coca-cola.com",
      status: "Active",
    },
    {
      id: "sub006",
      name: "Coca-Cola Colombia",
      type: "Advertiser",
      country: "Colombia",
      isHolding: false,
      holdingName: "Coca-Cola Latin America",
      holdingId: "org008",
      isBigSix: false,
      legalName: "Coca-Cola de Colombia S.A.",
      taxId: "CCC567890CO",
      website: "https://www.coca-cola.com.co",
      contactName: "Andrés Gómez",
      contactEmail: "andres.gomez@coca-cola.com",
      status: "Inactive",
    },
    {
      id: "sub007",
      name: "GroupM Colombia",
      type: "Agency",
      country: "Colombia",
      isHolding: false,
      holdingName: "WPP",
      holdingId: "org005",
      isBigSix: true,
      legalName: "GroupM Colombia S.A.S.",
      taxId: "GMC123456CO",
      website: "https://www.groupm.com/colombia",
      contactName: "Catalina Restrepo",
      contactEmail: "catalina.restrepo@groupm.com",
      status: "Active",
    },
    {
      id: "sub008",
      name: "Mindshare Brazil",
      type: "Agency",
      country: "Brazil",
      isHolding: false,
      holdingName: "WPP",
      holdingId: "org005",
      isBigSix: true,
      legalName: "Mindshare Brasil Ltda.",
      taxId: "MSB789012BR",
      website: "https://www.mindshareworld.com/brazil",
      contactName: "Paulo Oliveira",
      contactEmail: "paulo.oliveira@mindshare.com",
      status: "Active",
    },
  ];
