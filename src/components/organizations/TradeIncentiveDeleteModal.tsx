...
interface TradeIncentiveDeleteModalProps {
  isOpen: boolean;
  onConfirm: () => void;
  onCancel: () => void;
}

const TradeIncentiveDeleteModal: React.FC<TradeIncentiveDeleteModalProps> = ({
  isOpen,
  onConfirm,
  onCancel,
}) => {
...
export default TradeIncentiveDeleteModal;
