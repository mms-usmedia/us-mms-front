...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-white p-1 text-gray-500 relative",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "relative",
      "after:content-[''] after:absolute after:right-0 after:top-[15%] after:h-[70%] after:w-px after:bg-gray-200 last:after:hidden",
      className
    )}
    style={
      {
