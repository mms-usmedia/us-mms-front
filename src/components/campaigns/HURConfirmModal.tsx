...
interface HURConfirmModalProps {
  isOpen: boolean;
  onConfirm: () => void;
  onCancel: () => void;
}

const HURConfirmModal: React.FC<HURConfirmModalProps> = ({
  isOpen,
  onConfirm,
  onCancel,
}) => {
      ...
      >
        <div className="text-center">
          ...
          <p className="mb-5 text-sm text-gray-500">
            This action will initiate the Hold Until Resolved process for this
            campaign.
          </p>
...
export default HURConfirmModal;
