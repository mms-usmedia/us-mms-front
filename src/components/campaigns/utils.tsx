...
/**
 * Formatea un valor de moneda con el símbolo $ y separadores de miles
 */
...
/**
 * Trunca un texto si es más largo que maxLength y añade puntos suspensivos
 */
...
/**
 * Formatea el tamaño de un archivo a KB, MB, etc.
 */
