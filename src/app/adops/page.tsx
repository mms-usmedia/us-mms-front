                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-2">
                          <div className="w-1/2">
                            ...
                            <input
                              ...
                              className="block w-full border border-gray-200 rounded-md shadow-sm py-1.5 px-2 text-sm"
                            />
                          </div>
                          <div className="w-1/2">
                            <label className="text-xs text-gray-500">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="block w-full border border-gray-200 rounded-md shadow-sm py-1.5 px-2 text-sm text-gray-700 bg-white"
                        >
